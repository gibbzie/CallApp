...
function C2(t2) {
  ...
  if (A2.logLevel <= LogLevel.DEBUG) {
    var i = n.map(L2);
    A2.debug.apply(A2, __spreadArray(["Firestore (8.10.0): " + t2], i));
  }
}
function x2(t2) {
  for (var n = [], r = 1; r < arguments.length; r++)
  ...
  if (A2.logLevel <= LogLevel.ERROR) {
    var i = n.map(L2);
    A2.error.apply(A2, __spreadArray(["Firestore (8.10.0): " + t2], i));
  }
}
function R2(t2) {
  for (var n = [], r = 1; r < arguments.length; r++)
  ...
  if (A2.logLevel <= LogLevel.WARN) {
    var i = n.map(L2);
    A2.warn.apply(A2, __spreadArray(["Firestore (8.10.0): " + t2], i));
  }
}
function L2(t2) {
  if (typeof t2 == "string")
...
function O2(t2) {
  ...
  var e = "FIRESTORE (8.10.0) INTERNAL ASSERTION FAILED: " + t2;
...
var W2 = function() {
  function t2(t3, e, n) {
    e === void 0 ? e = 0 : e > t3.length && O2(), n === void 0 ? n = t3.length - e : n > t3.length - e && O2(), this.segments = t3, this.offset = e, this.len = n;
  }
...
function nt(t2) {
  return typeof t2 == "string" ? J2.fromBase64String(t2) : J2.fromUint8Array(t2);
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var ct = function() {
  ...
  return t2.fromPath = function(e) {
    ...
    return t3 !== null && H2.comparator(this.path, t3.path) === 0;
  }, t2.prototype.toString = function() {
  ...
  switch (n) {
    ...
    case 8:
      return function(t3, e2) {
        ...
        return n2 !== 0 ? n2 : q2(et(t3.longitude), et(e2.longitude));
...
function Et(t2) {
  ...
  if (t2.mapValue) {
    ...
    return G(t2.mapValue.fields, function(t3, n2) {
...
function St(t2) {
  var e = [];
  return G(t2.fields, function(t3, n) {
    var r = new $([t3]);
    if (Tt(n)) {
...
var Nt = function() {
  ...
  return t2.newInvalidDocument = function(e) {
    ...
    return this.version = t3, this.documentType = 2, this.data = _t.empty(), this.documentState = 0, this;
  }, t2.prototype.convertToUnknownDocument = function(t3) {
    return this.version = t3, this.documentType = 3, this.data = _t.empty(), this.documentState = 2, this;
...
function At(t2, e, n, r, i, o, s) {
  return e === void 0 && (e = null), n === void 0 && (n = []), r === void 0 && (r = []), i === void 0 && (i = null), o === void 0 && (o = null), s === void 0 && (s = null), new Dt(t2, e, n, r, i, o, s);
}
function kt(t2) {
  var e = F2(t2);
  if (e.h === null) {
...
function Ct(t2, e) {
  ...
  for (var n = 0; n < t2.orderBy.length; n++)
    if (!Qt(t2.orderBy[n], e.orderBy[n]))
      return false;
...
var Rt = function(e) {
  ...
  return __extends(n, e), n.create = function(t2, e2, r) {
    return t2.isKeyField() ? e2 === "in" || e2 === "not-in" ? this.l(t2, e2, r) : new Lt(t2, e2, r) : e2 === "array-contains" ? new Mt(t2, r) : e2 === "in" ? new Vt(t2, r) : e2 === "not-in" ? new qt(t2, r) : e2 === "array-contains-any" ? new Ut(t2, r) : new n(t2, e2, r);
  }, n.l = function(t2, e2, n2) {
    return e2 === "in" ? new Ot(t2, n2) : new Pt(t2, n2);
...
function ue(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    ...
    return !(t3.startAt && !Gt(t3.startAt, ee(t3), e2)) && (!t3.endAt || !Gt(t3.endAt, ee(t3), e2));
  }(t2, e);
}
function ae(t2) {
  return function(e, n) {
...
function pe(t2, e, n) {
  return t2 instanceof me ? function(t3, e2) {
    ...
    var n2 = ve(t3, e2), r = Ee(n2) + Ee(t3.A);
...
function Le(t2, e) {
  return t2.type === e.type && !!t2.key.isEqual(e.key) && !!t2.precondition.isEqual(e.precondition) && !!function(t3, e2) {
    return t3 === void 0 && e2 === void 0 || !(!t3 || !e2) && U2(t3, e2, function(t4, e3) {
...
var dn = function(t2, e, n, r) {
  n === void 0 && (n = J2.EMPTY_BYTE_STRING), r === void 0 && (r = null), this.state = t2, this.targetIds = e, this.resumeToken = n, this.cause = r;
};
var pn = function() {
  function t2() {
...
var yn = function() {
  function t2(t3) {
    this.W = t3, this.G = new Map(), this.H = Ze(), this.J = vn(), this.Y = new $e(q2);
  }
    ...
    this.G.forEach(function(r2, i2) {
      ...
      if (o) {
        if (r2.current && xt(o.target)) {
          ...
          e.H.get(s) !== null || e.at(i2, s) || e.tt(i2, s, Nt.newNoDocument(s, t3));
        }
...
function Rn(t2) {
  return P2(t2.length > 4 && t2.get(4) === "documents"), t2.popFirst(5);
}
function Ln(t2, e, n) {
  return {
    name: Dn(t2, e),
...
function On(t2, e, n) {
  var r = An(t2, e.name), i = _n(e.updateTime), o = new _t({
    mapValue: {
      fields: e.fields
    }
...
function Fn(t2, e) {
  var n = e.currentDocument ? function(t3) {
    return t3.updateTime !== void 0 ? De.updateTime(_n(t3.updateTime)) : t3.exists !== void 0 ? De.exists(t3.exists) : De.none();
  ...
  if (e.update) {
    e.update.name;
    var i = An(t2, e.update.name), o = new _t({
      mapValue: {
...
function Vn(t2, e) {
  ...
  e.collectionGroup !== null ? (n.parent = kn(t2, r), n.structuredQuery.from = [{
...
function qn(t2) {
  ...
  n.orderBy && (u = n.orderBy.map(function(t3) {
    return function(t4) {
      return new Kt(zn(t4.field), function(t5) {
        switch (t5) {
          case "ASCENDING":
            return "asc";
          case "DESCENDING":
  ...
  n.limit && (a = function(t3) {
    var e2;
    return st(e2 = typeof t3 == "object" ? t3.value : t3) ? null : e2;
  }(n.limit));
  var c = null;
...
function Un(t2) {
  return t2 ? t2.unaryFilter !== void 0 ? [Hn(t2)] : t2.fieldFilter !== void 0 ? [Wn(t2)] : t2.compositeFilter !== void 0 ? t2.compositeFilter.filters.map(function(t3) {
    return Un(t3);
...
var Er = function() {
  function t2(e, n, r) {
    this.name = e, this.version = n, this.wt = r, t2._t(getUA()) === 12.2 && x2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
          ...
          case 0:
            return this.db ? [3, 2] : (C2("SimpleDb", "Opening database:", this.name), e = this, [4, new Promise(function(e2, r2) {
              ...
              i.onsuccess = function(t4) {
                ...
                n2.name === "VersionError" ? r2(new D2(N2.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r2(new Sr(t3, n2));
...
var Dr = function() {
  ...
  return t2.prototype.put = function(t3, e) {
    var n;
    return e !== void 0 ? (C2("SimpleDb", "PUT", this.store.name, t3, e), n = this.store.put(e, t3)) : (C2("SimpleDb", "PUT", this.store.name, "<auto-key>", t3), n = this.store.put(t3)), Ar(n);
  }, t2.prototype.add = function(t3) {
    return C2("SimpleDb", "ADD", this.store.name, t3, t3), Ar(this.store.add(t3));
  }, t2.prototype.get = function(t3) {
    var e = this;
    return Ar(this.store.get(t3)).next(function(n) {
      return n === void 0 && (n = null), C2("SimpleDb", "GET", e.store.name, t3, n), n;
    });
  }, t2.prototype.delete = function(t3) {
...
var Pr = function() {
  function t2(t3, e, n, r, i, o, s) {
    i === void 0 && (i = K2.min()), o === void 0 && (o = K2.min()), s === void 0 && (s = J2.EMPTY_BYTE_STRING), this.target = t3, this.targetId = e, this.purpose = n, this.sequenceNumber = r, this.snapshotVersion = i, this.lastLimboFreeSnapshotVersion = o, this.resumeToken = s;
  }
...
function Qr(t2) {
  var e, n, r = jr(t2.readTime), i = t2.lastLimboFreeSnapshotVersion !== void 0 ? jr(t2.lastLimboFreeSnapshotVersion) : K2.min();
  return t2.query.documents !== void 0 ? (P2((n = t2.query).documents.length === 1), e = ne(Yt(Cn(n.documents[0])))) : e = function(t3) {
    return ne(qn(t3));
...
function zr(t2) {
  ...
  return t2.limitType === "LAST" ? re(e, e.limit, "L") : e;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var hi = function() {
  ...
  return t2.prototype.allocateTargetId = function(t3) {
    ...
    var n = di(t3), r = IDBKeyRange.bound([e], [e + 1], false, true);
    return n.delete(r);
  }, t2.prototype.getMatchingKeysForTargetId = function(t3, e) {
    var n = IDBKeyRange.bound([e], [e + 1], false, true), r = di(t3), i = sn();
    return r.$t({
      range: n,
      Ft: true
    }, function(t4, e2, n2) {
...
var gi = function() {
  ...
  return t2.prototype.calculateTargetCount = function(t3, e) {
    ...
    var n = this;
    return this.params.cacheSizeCollectionThreshold === -1 ? (C2("LruGarbageCollector", "Garbage collection skipped; disabled"), Ir.resolve(ti)) : this.getCacheSize(t3).next(function(r) {
...
function bi(t2, e) {
  return di(t2).put(function(t3, e2) {
...
var Ti = function() {
  ...
  return t2.prototype.getReadTime = function(t3) {
    ...
    return n !== void 0 ? Ir.resolve(n.document) : this.getFromCache(t3, e);
...
var Ei = function() {
  ...
  return t2.prototype.addEntry = function(t3, e, n) {
    ...
    return new _i(this, !!t3 && t3.trackRemovals);
...
var Ai = function() {
  ...
  return t2.prototype.Rt = function(t3, e, n, r) {
    ...
    return n < 3 && r >= 3 && (n !== 0 && (function(t4) {
      ...
      return function(t4) {
        var e2 = t4.store(lr.store), n2 = new lr(0, 0, K2.min().toTimestamp(), 0);
...
var xi = function() {
  function t2(e, n, r, i, o, s, u, a, c, h) {
    ...
    this.referenceDelegate = new wi(this, i), this.Le = n + "main", this.R = new Fr(a), this.Be = new Er(this.Le, 11, new Ai(this.R)), this.qe = new hi(this.referenceDelegate, this.R), this.Ut = new Jr(), this.Ue = function(t3, e2) {
      return new Ei(t3, e2);
  ...
  return t2.prototype.start = function() {
    ...
    return this.Be.runTransaction(t3, o, mr, function(o2) {
      return i = new xr(o2, r.Ne ? r.Ne.next() : S2.o), e === "readwrite-primary" ? r.Je(i).next(function(t4) {
        return !!t4 || r.Ye(i);
      }).next(function(e2) {
        if (!e2)
    ...
    var t3, e = this;
    typeof ((t3 = this.window) === null || t3 === void 0 ? void 0 : t3.addEventListener) == "function" && (this.ke = function() {
...
var Fi = function() {
  ...
  return t2.prototype.mn = function(t3, e) {
    ...
    return function(t4) {
      return ct.isDocumentKey(t4.path) && t4.collectionGroup === null && t4.filters.length === 0;
    ...
    return this.Ut.getCollectionParents(t3, i).next(function(s) {
      return Ir.forEach(s, function(s2) {
        var u = function(t4, e2) {
          return new Wt(e2, null, t4.explicitOrderBy.slice(), t4.filters.slice(), t4.limit, t4.limitType, t4.startAt, t4.endAt);
        }(e, s2.child(i));
...
function Qi(t2, e) {
  ...
  return n.persistence.runTransaction("Apply remote event", "readwrite-primary", function(t3) {
      ...
      if (u2) {
        ...
        if (a2.approximateByteSize() > 0) {
          ...
          i = i.insert(o2, c), function(t4, e3, n2) {
            return P2(e3.resumeToken.approximateByteSize() > 0), t4.resumeToken.approximateByteSize() === 0 || (e3.snapshotVersion.toMicroseconds() - t4.snapshotVersion.toMicroseconds() >= 3e8 || n2.addedDocuments.size + n2.modifiedDocuments.size + n2.removedDocuments.size > 0);
    ...
    }), s.push(Gi(t3, o, e.documentUpdates, r, void 0).next(function(t4) {
      u = t4;
    })), !r.isEqual(K2.min())) {
...
function Wi(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", function(t3) {
    ...
    return (r === null || t3.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.kn = n.kn.insert(t3.targetId, t3), n.Fn.set(e, t3.targetId)), t3;
  });
}
function Hi(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
      ...
      switch (r.label) {
        ...
        case 1:
          return p2 = r.sent(), [2, n.persistence.runTransaction("Apply bundle documents", "readwrite", function(t3) {
            return Gi(t3, d, u, K2.min(), a).next(function(e2) {
...
var vo = function() {
  ...
  return t2.Vs = function(e, n, r) {
    ...
    return s && o.error && ((s = typeof o.error.message == "string" && typeof o.error.code == "string") && (i = new D2(o.error.code, o.error.message))), s ? new t2(e, n, o.state, i) : (x2("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), null);
...
var mo = function() {
  ...
  return t2.Vs = function(e, n) {
    ...
    return o && i.error && ((o = typeof i.error.message == "string" && typeof i.error.code == "string") && (r = new D2(i.error.code, i.error.message))), o ? new t2(e, i.state, r) : (x2("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), null);
  }, t2.prototype.Ss = function() {
    var t3 = {
      state: this.state,
      updateTimeMs: Date.now()
...
var wo = function() {
  ...
  return t2.Vs = function(e) {
    var n = JSON.parse(e);
    return typeof n == "object" && ["Unknown", "Online", "Offline"].indexOf(n.onlineState) !== -1 && typeof n.clientId == "string" ? new t2(n.clientId, n.onlineState) : (x2("SharedClientState", "Failed to parse online state: " + e), null);
  }, t2;
}();
var bo = function() {
  function t2() {
...
var Do = function(e) {
  ...
  return t2.prototype.Ni = function(t3, e, n, r) {
    ...
    if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.10.0", t3["Content-Type"] = "text/plain", this.databaseInfo.appId && (t3["X-Firebase-GMPID"] = this.databaseInfo.appId), e)
  ...
  return t2.prototype.tr = function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(n) {
        switch (n.label) {
          case 0:
            return this.ur(), this.Zi.cancel(), this.Yi++, t3 !== 3 ? this.Zi.reset() : e && e.code === N2.RESOURCE_EXHAUSTED ? (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.Zi.Qi()) : e && e.code === N2.UNAUTHENTICATED && this.Ji.invalidateToken(), this.stream !== null && (this.ar(), this.stream.close(), this.stream = null), this.state = t3, [4, this.listener.Ri(e)];
          case 1:
            return n.sent(), [2];
        }
      });
  ...
  return __extends(n, e), n.prototype.wr = function(t2) {
    ...
    var e2 = function(t3, e3) {
      ...
      if ("targetChange" in e3) {
        e3.targetChange;
        var r = function(t4) {
          return t4 === "NO_CHANGE" ? 0 : t4 === "ADD" ? 1 : t4 === "REMOVE" ? 2 : t4 === "CURRENT" ? 3 : t4 === "RESET" ? 4 : O2();
        }(e3.targetChange.targetChangeType || "NO_CHANGE"), i = e3.targetChange.targetIds || [], o = function(t4, e4) {
          return t4.I ? (P2(e4 === void 0 || typeof e4 == "string"), J2.fromBase64String(e4 || "")) : (P2(e4 === void 0 || e4 instanceof Uint8Array), J2.fromUint8Array(e4 || new Uint8Array()));
        }(t3, e3.targetChange.resumeToken), s = (u = e3.targetChange.cause) && function(t4) {
          var e4 = t4.code === void 0 ? N2.UNKNOWN : ze(t4.code);
          return new D2(e4, t4.message || "");
        }(u);
        n3 = new dn(r, i, o, s || null);
      } else if ("documentChange" in e3) {
        e3.documentChange, (r = e3.documentChange).document, r.document.name, r.document.updateTime, i = An(t3, r.document.name), o = _n(r.document.updateTime);
        var u = new _t({
          mapValue: {
        ...
        e3.documentDelete, (r = e3.documentDelete).document, i = An(t3, r.document), o = r.readTime ? _n(r.readTime) : K2.min(), u = Nt.newNoDocument(i, o), s = r.removedTargetIds || [], n3 = new fn([], s, u.key, u);
...
var Oo = function(e) {
  ...
  return __extends(n, e), Object.defineProperty(n.prototype, "pr", {
    ...
    if (P2(!!t2.streamToken), this.lastStreamToken = t2.streamToken, this.gr) {
      this.Zi.reset();
      var e2 = function(t3, e3) {
        return t3 && t3.length > 0 ? (P2(e3 !== void 0), t3.map(function(t4) {
          return function(t5, e4) {
            var n3 = t5.updateTime ? _n(t5.updateTime) : _n(e4);
            return n3.isEqual(K2.min()) && (n3 = _n(e4)), new Ne(n3, t5.transformResults || []);
          }(t4, e3);
        })) : [];
      }(t2.writeResults, t2.commitTime), n2 = _n(t2.commitTime);
      return this.listener.Tr(n2, e2);
    }
    return P2(!t2.writeResults || t2.writeResults.length === 0), this.gr = true, this.listener.Ir();
  }, n.prototype.Ar = function() {
    var t2 = {};
...
var Po = function(e) {
  ...
  return __extends(n, e), n.prototype.br = function() {
    ...
    return this.br(), this.credentials.getToken().then(function(i) {
      ...
      throw t3.name === "FirebaseError" ? (t3.code === N2.UNAUTHENTICATED && r.credentials.invalidateToken(), t3) : new D2(N2.UNKNOWN, t3.toString());
    });
...
var Fo = function() {
  ...
  return t2.prototype.Sr = function() {
    ...
    this.state === "Online" ? this.Dr("Unknown") : (this.vr++, this.vr >= 1 && (this.kr(), this.Cr("Connection failed 1 times. Most recent error: " + t3.toString()), this.Dr("Offline")));
  }, t2.prototype.set = function(t3) {
    this.kr(), this.vr = 0, t3 === "Online" && (this.Vr = false), this.Dr(t3);
  }, t2.prototype.Dr = function(t3) {
...
var Mo = function(t2, e, i, o, s) {
  var u = this;
  this.localStore = t2, this.datastore = e, this.asyncQueue = i, this.remoteSyncer = {}, this.Fr = [], this.$r = new Map(), this.Or = new Set(), this.Mr = [], this.Lr = s, this.Lr.di(function(t3) {
...
function Yo(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(n) {
      return Wo(t2), Go(t2) ? (t2.Br.Nr(e), Qo(t2)) : t2.Br.set("Unknown"), [2];
    });
  });
}
function $o(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        case 0:
          if (t2.Br.set("Online"), !(e instanceof dn && e.state === 2 && e.cause))
            return [3, 6];
          a.label = 1;
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 3:
          return (o = r.sent()) === null ? (e.Fr.length === 0 && n.ir(), [3, 7]) : (i = o.batchId, function(t3, e2) {
            t3.Fr.push(e2);
            var n2 = as(t3);
          ...
          return e && as(t2).pr ? [4, function(t3, e2) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    return Ge(i2 = e2.code) && i2 !== N2.ABORTED ? (n = t3.Fr.shift(), as(t3).sr(), [4, Jo(t3, function() {
  ...
  return t2.Ur || (t2.Ur = function(t3, e2, n) {
    ...
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return i ? (t2.Ur.sr(), Go(t2) ? Qo(t2) : t2.Br.set("Unknown"), [3, 3]) : [3, 1];
          case 1:
            return [4, t2.Ur.stop()];
          case 2:
...
var cs = function() {
  ...
  return t2.createAndSchedule = function(e, n, r, i, o) {
    ...
    this.timerHandle !== null && (this.clearTimeout(), this.deferred.reject(new D2(N2.CANCELLED, "Operation cancelled" + (t3 ? ": " + t3 : ""))));
...
var ds = function() {
  ...
  return t2.fromInitialDocuments = function(e, n, r, i) {
    ...
    }), new t2(e, n, fs.emptySet(n), o, r, i, true, false);
  }, Object.defineProperty(t2.prototype, "hasPendingWrites", {
    get: function() {
...
function ms(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n, i, o, s, u;
    return __generator(this, function(r) {
      return n = F2(t2), i = e.query, o = false, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), o = s.listeners.length === 0), o ? [2, (n.queries.delete(i), n.onUnlisten(i))] : [2];
    });
  });
}
function gs(t2, e) {
...
var Is = function() {
  ...
  return t2.prototype.Hr = function(t3) {
    if (!this.options.includeMetadataChanges) {
      ...
      t3 = new ds(t3.query, t3.docs, t3.oldDocs, e, t3.mutatedKeys, t3.fromCache, t3.syncStateChanged, true);
    }
    var o = false;
...
var As = function() {
  ...
  return Object.defineProperty(t2.prototype, "wo", {
    ...
    return this.ao = u, o.length !== 0 || a ? {
      snapshot: new ds(this.query, t3.fo, i, o, t3.mutatedKeys, u === 0, a, false),
      To: s
    } : {
      To: s
    };
            ...
            return function(t3, e3, i3, o3) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    case 0:
                      return n = e3.view._o(i3), n.Nn ? [4, Yi(t3.localStore, e3.query, false).then(function(t4) {
                        var r2 = t4.documents;
                    ...
                    case 1:
                      n = r.sent(), r.label = 2;
                    case 2:
                      return s2 = o3 && o3.targetChanges.get(e3.targetId), u2 = e3.view.applyChanges(n, t3.isPrimaryClient, s2), [2, (zs(t3, e3.targetId, u2.To), u2.snapshot)];
                  }
                });
              });
            }(t2, e2, i2, o2);
          }, [4, Yi(t2.localStore, e, true)];
        case 1:
          return s = l2.sent(), u = new As(e, s.Bn), a = u._o(s.documents), c = hn.createSynthesizedTargetChangeForCurrentChange(i, o && t2.onlineState !== "Offline"), h = u.applyChanges(a, t2.isPrimaryClient, c), zs(t2, i, h.To), f = new ks(e, i, u), [2, (t2.Po.set(e, f), t2.Vo.has(i) ? t2.Vo.get(i).push(e) : t2.Vo.set(i, [e]), h.snapshot)];
      }
    });
  });
}
...
function Vs(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return (n = F2(t2)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), (s = o && o.key) ? (u = (u = new We(ct.comparator)).insert(s, Nt.newNoDocument(s, K2.min())), a = sn().add(s), c = new cn(K2.min(), new Map(), new $e(q2), u, a), [4, Fs(n, c)]) : [3, 2];
        case 1:
          ...
          return r.trys.push([1, 4, , 6]), [4, function(t3, e2) {
            ...
            return n2.persistence.runTransaction("Reject batch", "readwrite-primary", function(t4) {
              ...
              return n2._n.lookupMutationBatch(t4, e2).next(function(e3) {
                return P2(e3 !== null), r2 = e3.keys(), n2._n.removeMutationBatch(t4, e3);
              }).next(function() {
...
function Gs(t2, e) {
  ...
  var n = t2.Do.get(e);
  n !== null && (Bo(t2.remoteStore, n), t2.Do = t2.Do.remove(e), t2.Co.delete(n), Hs(t2));
}
function zs(t2, e, n) {
  for (var r = 0, i = n; r < i.length; r++) {
    var o = i[r];
    o instanceof Ns ? (t2.No.addReference(o.key, e), Ws(t2, o)) : o instanceof Ds ? (C2("SyncEngine", "Document no longer in limbo: " + o.key), t2.No.removeReference(o.key, e), t2.No.containsKey(o.key) || Gs(t2, o.key)) : O2();
  }
}
function Ws(t2, e) {
...
function Js(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return [4, Yi((n = F2(t2)).localStore, e.query, true)];
        case 1:
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 2:
          return r.sent(), [3, 4];
        case 3:
          i === "acknowledged" || i === "rejected" ? (Ks(n, e, o || null), js(n, e), function(t3, e2) {
            F2(F2(t3)._n).Gt(e2);
...
function eu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return uu(n = F2(t2)), au(n), e !== true || n.$o === true ? [3, 3] : (i = n.sharedClientState.getAllActiveQueryTargets(), [4, nu(n, i.toArray())]);
        case 1:
        ...
        case 6:
          h = function(t3) {
            return __generator(this, function(e2) {
              switch (e2.label) {
                case 0:
                  return n.Vo.has(t3) ? [4, Hi(n.localStore, t3, false).then(function() {
                    Bo(n.remoteStore, t3), Qs(n, t3);
                  }).catch(pi)] : [3, 2];
                case 1:
                  e2.sent(), e2.label = 2;
                case 2:
...
var fu = function(e) {
  ...
  return __extends(i, e), i.prototype.initialize = function(t2) {
    ...
    var e2 = Oi(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = this.cacheSizeBytes !== void 0 ? ei.withCacheSize(this.cacheSizeBytes) : ei.DEFAULT;
                      ...
                      return s = r.sent(), u = new Map(), s.forEach(function(t5) {
                        var e3 = function(t6, e4) {
                          return "found" in e4 ? function(t7, e5) {
                            ...
                            var n2 = An(t7, e5.found.name), r2 = _n(e5.found.updateTime), i3 = new _t({
                              mapValue: {
                            ...
                            var n2 = An(t7, e5.missing), r2 = _n(e5.readTime);
...
var Mu = function() {
  ...
  return t2.prototype.getToken = function() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(n).then(function(n2) {
      return t3.cc !== e ? (C2("FirebaseCredentialsProvider", "getToken aborted due to token change."), t3.getToken()) : n2 ? (P2(typeof n2.accessToken == "string"), new Ou(n2.accessToken, t3.currentUser)) : null;
    ...
    return P2(t3 === null || typeof t3 == "string"), new fo(t3);
  }, t2;
}();
var Vu = function() {
  function t2(t3, e, n) {
  ...
  return Object.defineProperty(t2.prototype, "app", {
    ...
    this._settings = new Hu(t3), t3.credentials !== void 0 && (this._credentials = function(t4) {
      ...
      switch (t4.type) {
        case "gapi":
          var e = t4.client;
          return P2(!(typeof e != "object" || e === null || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new qu(e, t4.sessionIndex || "0", t4.iamToken || null);
        case "provider":
          return t4.client;
        default:
...
var Ju = function(e) {
  ...
  return __extends(n, e), Object.defineProperty(n.prototype, "id", {
    ...
    get: function() {
      ...
      return t2.isEmpty() ? null : new $u(this.firestore, null, new ct(t2));
    },
    enumerable: false,
    configurable: true
...
function Zu(t2, n) {
  ...
  if (t2 = getModularInstance(t2), Uu("collection", "path", n), t2 instanceof Yu)
    return Qu(r = H2.fromString.apply(H2, __spreadArray([n], i))), new Ju(t2, null, r);
  ...
  return Qu(r = H2.fromString.apply(H2, __spreadArray([t2.path], i)).child(H2.fromString(n))), new Ju(t2.firestore, null, r);
}
function ta2(t2, n) {
  for (var r, i = [], o = 2; o < arguments.length; o++)
    i[o - 2] = arguments[o];
  if (t2 = getModularInstance(t2), arguments.length === 1 && (n = V2.u()), Uu("doc", "path", n), t2 instanceof Yu)
    return Ku(r = H2.fromString.apply(H2, __spreadArray([n], i))), new $u(t2, null, new ct(r));
  if (!(t2 instanceof $u || t2 instanceof Ju))
    throw new D2(N2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
  ...
  return Object.defineProperty(t2.prototype, "isShuttingDown", {
    ...
    var e = this, n = this.dc.then(function() {
      return e.gc = true, t3().catch(function(t4) {
        throw e.yc = t4, e.gc = false, x2("INTERNAL UNHANDLED ERROR: ", function(t5) {
          var e2 = t5.message || "";
    ...
    return __awaiter(o, void 0, void 0, function() {
      ...
      return __generator(this, function(r) {
        switch (r.label) {
          ...
          case 3:
            if (!function(t3) {
              return t3.name === "FirebaseError" ? t3.code === N2.FAILED_PRECONDITION || t3.code === N2.UNIMPLEMENTED : !(typeof DOMException != "undefined" && t3 instanceof DOMException) || (t3.code === 22 || t3.code === 20 || t3.code === 11);
            }(n = r.sent()))
              throw n;
...
var ma2 = function() {
  ...
  return t2.prototype.toMutation = function(t3, e) {
    return this.fieldMask !== null ? new Fe(t3, this.data, this.fieldMask, e, this.fieldTransforms) : new Pe(t3, this.data, e, this.fieldTransforms);
  }, t2;
}();
var ga = function() {
  function t2(t3, e, n) {
...
var ba2 = function() {
  function t2(t3, e, n, r, i, o) {
    this.settings = t3, this.databaseId = e, this.R = n, this.ignoreUndefinedProperties = r, i === void 0 && this.Cc(), this.fieldTransforms = i || [], this.fieldMask = o || [];
  }
  return Object.defineProperty(t2.prototype, "path", {
    ...
    var e, n = (e = this.path) === null || e === void 0 ? void 0 : e.child(t3), r = this.xc({
      path: n,
      Fc: false
    });
    return r.$c(t3), r;
...
var Da = function(e) {
  ...
  return __extends(n, e), n.prototype._toFieldTransform = function(t2) {
    var e2 = Sa2(this, t2, true), n2 = this.Kc.map(function(t3) {
      return La2(t3, e2);
    }), r = new ge(n2);
...
function Ra2(t2, e, n, r) {
  return r === void 0 && (r = false), La2(n, t2.Uc(r ? 4 : 3, e));
}
function La2(t2, e) {
  if (Pa(t2 = getModularInstance(t2)))
  ...
  return function(t3, e2) {
    ...
    throw e2.Lc("Unsupported field value: " + Gu(t3));
  }(t2, e);
}
function Oa(t2, e) {
  var n = {};
  return z2(t2) ? e.path && e.path.length > 0 && e.fieldMask.push(e.path) : G(t2, function(t3, r) {
    var i = La2(r, e.kc(t3));
    i != null && (n[t3] = i);
  }), {
    mapValue: {
...
function Pa(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof j || t2 instanceof ya2 || t2 instanceof da2 || t2 instanceof $u || t2 instanceof pa2);
}
function Fa2(t2, e, n) {
  if (!Pa(n) || !function(t3) {
    ...
    var r = Gu(n);
    throw r === "an object" ? e.Lc(t2 + " a custom object") : e.Lc(t2 + " " + r);
  }
}
function Ma2(t2, e, n) {
  ...
  if (typeof e == "string")
    return qa2(t2, e);
  throw Ua2("Field path arguments must be of type string or FieldPath.", t2, false, void 0, n);
}
var Va2 = new RegExp("[~\\*/\\[\\]]");
function qa2(t2, n, r) {
  if (n.search(Va2) >= 0)
    throw Ua2("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t2, false, void 0, r);
  try {
    return new (la2.bind.apply(la2, __spreadArray([void 0], n.split("."))))()._internalPath;
  } catch (e) {
    throw Ua2("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t2, false, void 0, r);
  }
}
...
var ja2 = function() {
  ...
  return Object.defineProperty(t2.prototype, "id", {
    ...
    if (this._document) {
      var e = this._document.data.field(Qa("DocumentSnapshot.get", t3));
      if (e !== null)
...
function Qa(t2, e) {
  return typeof e == "string" ? qa2(t2, e) : e instanceof la2 ? e._internalPath : e._delegate._internalPath;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var za2 = function(e) {
  ...
  return __extends(n, e), n.prototype.exists = function() {
    ...
    if (e2 === void 0 && (e2 = {}), this._document) {
      var n2 = this._document.data.field(Qa("DocumentSnapshot.get", t2));
      if (n2 !== null)
...
var Ha2 = function() {
  function t2(t3, e, n, r) {
    this._firestore = t3, this._userDataWriter = e, this._snapshot = r, this.metadata = new Ga2(r.hasPendingWrites, r.fromCache), this.query = n;
  }
  return Object.defineProperty(t2.prototype, "docs", {
    ...
    this._snapshot.docs.forEach(function(r) {
      t3.call(e, new Wa2(n._firestore, n._userDataWriter, r.key, r, new Ga2(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
    });
    ...
    return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function(t4, e2) {
      if (t4._snapshot.oldDocs.isEmpty()) {
        ...
        return t4._snapshot.docChanges.map(function(e3) {
          return {
            type: "added",
            doc: new Wa2(t4._firestore, t4._userDataWriter, e3.doc.key, e3.doc, new Ga2(t4._snapshot.mutatedKeys.has(e3.doc.key), t4._snapshot.fromCache), t4.query.converter),
            oldIndex: -1,
            newIndex: n++
          };
        });
      ...
      return t4._snapshot.docChanges.filter(function(t5) {
        ...
        var n2 = new Wa2(t4._firestore, t4._userDataWriter, e3.doc.key, e3.doc, new Ga2(t4._snapshot.mutatedKeys.has(e3.doc.key), t4._snapshot.fromCache), t4.query.converter), i = -1, o = -1;
...
function $a2(t2, e) {
  return t2 instanceof za2 && e instanceof za2 ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (t2._document === null ? e._document === null : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof Ha2 && e instanceof Ha2 && t2._firestore === e._firestore && na2(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot);
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var cc2 = function() {
  ...
  return t2.prototype.convertValue = function(t3, e) {
    ...
    var n = this, r = {};
    return G(t3.fields, function(t4, i) {
...
var lc2 = function() {
  ...
  return t2.prototype.set = function(t3, e, n) {
    ...
    var r = dc2(t3, this._firestore), i = hc2(r.converter, e, n), o = Ea(this._dataReader, "WriteBatch.set", r._key, i, r.converter !== null, n);
...
function yc2(t2, e, n) {
  ...
  return mc2(o, [(typeof (e = getModularInstance(e)) == "string" || e instanceof la2 ? xa2(s, "updateDoc", t2._key, e, n, r) : Ca2(s, "updateDoc", t2._key, e)).toMutation(t2._key, De.exists(true))]);
}
function vc2(t2) {
...
function gc2(t2, e, n) {
  ...
  return new za2(t2, i, e._key, r, new Ga2(n.hasPendingWrites, n.fromCache), e.converter);
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var wc2 = function(e) {
  ...
  return __extends(n, e), n.prototype.get = function(t2) {
    ...
    return e.prototype.get.call(this, t2).then(function(t3) {
      return new za2(n2._firestore, i, r._key, t3._document, new Ga2(false, false), r.converter);
    });
  }, n;
}(function() {
  function t2(t3, e) {
  ...
  return t2.prototype.get = function(t3) {
    ...
    var r = dc2(t3, this._firestore), i = hc2(r.converter, e, n), o = Ea(this._dataReader, "Transaction.set", r._key, i, r.converter !== null, n);
...
var Tc2 = function() {
  ...
  return t2.fromBase64String = function(e) {
    return Ic2(), new t2(da2.fromBase64String(e));
  }, t2.fromUint8Array = function(e) {
    return bc2(), new t2(da2.fromUint8Array(e));
  }, t2.prototype.toBase64 = function() {
...
var _c = function() {
  ...
  return Object.defineProperty(t2.prototype, "_databaseId", {
    ...
    n === void 0 && (n = {}), function(t4, e2, n2, r) {
      ...
      if (o.host !== "firestore.googleapis.com" && o.host !== e2 && R2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t4._setSettings(Object.assign(Object.assign({}, o), {
        host: e2 + ":" + n2,
        ssl: false
      })), r.mockUserToken) {
        var s, u;
        if (typeof r.mockUserToken == "string")
          ...
          s = createMockUserToken(r.mockUserToken, (i = t4._app) === null || i === void 0 ? void 0 : i.options.projectId);
    ...
    try {
      return new qc2(this, Zu(this._delegate, t3));
    } catch (t4) {
      throw xc2(t4, "collection()", "Firestore.collection()");
    }
  }, t2.prototype.doc = function(t3) {
    try {
      return new Cc2(this, ta2(this._delegate, t3));
    } catch (t4) {
      throw xc2(t4, "doc()", "Firestore.doc()");
    }
  }, t2.prototype.collectionGroup = function(t3) {
    try {
      return new Fc2(this, function(t4, e) {
        ...
        return new Xu(t4, null, function(t5) {
          return new Wt(H2.emptyPath(), t5);
        }(e));
      }(this._delegate, t3));
    } catch (t4) {
      throw xc2(t4, "collectionGroup()", "Firestore.collectionGroup()");
    }
...
var Dc2 = function() {
  function t2(t3, e) {
    this._firestore = t3, this._delegate = e, this._userDataWriter = new Sc2(t3);
  }
  return t2.prototype.get = function(t3) {
    var e = this, n = Uc2(t3);
    return this._delegate.get(n).then(function(t4) {
      return new Oc2(e._firestore, new za2(e._firestore._delegate, e._userDataWriter, t4._key, t4._document, t4.metadata, n.converter));
    });
  }, t2.prototype.set = function(t3, e, n) {
    var r = Uc2(t3);
...
var kc2 = function() {
  ...
  return t2.prototype.fromFirestore = function(t3, e) {
    var n = new Wa2(this._firestore._delegate, this._userDataWriter, t3._key, t3._document, t3.metadata, null);
    ...
    var o = i.get(n);
    return o || (o = new t2(e, new Sc2(e), n), i.set(n, o)), o;
  }, t2;
}();
kc2.su = new WeakMap();
var Cc2 = function() {
  function t2(t3, e) {
    this.firestore = t3, this._delegate = e, this._userDataWriter = new Sc2(t3);
  }
  return t2.iu = function(e, n, r) {
    ...
    try {
      return new qc2(this.firestore, Zu(this._delegate, t3));
    } catch (t4) {
      throw xc2(t4, "collection()", "DocumentReference.collection()");
    }
  }, t2.prototype.isEqual = function(t3) {
    ...
    try {
      return function(t4, e2, n) {
        t4 = zu(t4, $u);
        var r = zu(t4.firestore, ua2), i = hc2(t4.converter, e2, n);
        return mc2(r, [Ea(Ta(r), "setDoc", t4._key, i, t4.converter !== null, n).toMutation(t4._key, De.none())]);
      }(this._delegate, t3, e);
    } catch (t4) {
      throw xc2(t4, "setDoc()", "DocumentReference.set()");
    }
  }, t2.prototype.update = function(t3, n) {
    for (var r = [], i = 2; i < arguments.length; i++)
      r[i - 2] = arguments[i];
    try {
      return arguments.length === 1 ? yc2(this._delegate, t3) : yc2.apply(void 0, __spreadArray([this._delegate, t3, n], r));
    } catch (t4) {
      throw xc2(t4, "updateDoc()", "DocumentReference.update()");
    }
  }, t2.prototype.delete = function() {
    return mc2(zu((t3 = this._delegate).firestore, ua2), [new je(t3._key, De.none())]);
    var t3;
  }, t2.prototype.onSnapshot = function() {
    for (var t3 = this, e = [], n = 0; n < arguments.length; n++)
      e[n] = arguments[n];
    var r = Rc2(e), i = Lc2(e, function(e2) {
      return new Oc2(t3.firestore, new za2(t3.firestore._delegate, t3._userDataWriter, e2._key, e2._document, e2.metadata, t3._delegate.converter));
    });
    ...
    return ((t3 == null ? void 0 : t3.source) === "cache" ? function(t4) {
      ...
      return function(t5, e3) {
        ...
        return new za2(e2, o, t4._key, n, new Ga2(n !== null && n.hasLocalMutations, true), t4.converter);
      });
      ...
      return new Oc2(e.firestore, new za2(e.firestore._delegate, e._userDataWriter, t4._key, t4._document, t4.metadata, e._delegate.converter));
    });
  }, t2.prototype.withConverter = function(e) {
    return new t2(this.firestore, e ? this._delegate.withConverter(kc2.nu(this.firestore, e)) : this._delegate.withConverter(null));
  }, t2;
}();
function xc2(t2, e, n) {
...
function Lc2(t2, e) {
  ...
  return {
    ...
    error: (n = (i = ia2(t2[0]) ? t2[0] : ia2(t2[1]) ? t2[1] : typeof t2[0] == "function" ? {
      next: t2[0],
      error: t2[1],
      complete: t2[2]
    } : {
  ...
  return t2.prototype.where = function(e, n, r) {
    ...
    try {
      return new t2(this.firestore, Za2(this._delegate, function() {
        for (var t3 = [], e2 = 0; e2 < arguments.length; e2++)
          t3[e2] = arguments[e2];
        return new rc2("startAfter", t3, false);
      }.apply(void 0, e)));
    } catch (e2) {
    ...
    return ((t3 == null ? void 0 : t3.source) === "cache" ? function(t4) {
                  ...
                  return i3 = function(t6, e4, i4) {
                    return __awaiter(this, void 0, void 0, function() {
                      ...
                      return __generator(this, function(r) {
                        switch (r.label) {
                          case 0:
                            return r.trys.push([0, 2, , 3]), [4, Yi(t6, e4, true)];
                          case 1:
      ...
      return new Vc2(e.firestore, new Ha2(e.firestore._delegate, e._userDataWriter, e._delegate, t4._snapshot));
    });
  }, t2.prototype.onSnapshot = function() {
    for (var t3 = this, e = [], n = 0; n < arguments.length; n++)
      e[n] = arguments[n];
    var r = Rc2(e), i = Lc2(e, function(e2) {
      return new Vc2(t3.firestore, new Ha2(t3.firestore._delegate, t3._userDataWriter, t3._delegate, e2._snapshot));
    });
    return vc2(this._delegate, r, i);
  }, t2.prototype.withConverter = function(e) {
    return new t2(this.firestore, e ? this._delegate.withConverter(kc2.nu(this.firestore, e)) : this._delegate.withConverter(null));
  ...
  return Object.defineProperty(t2.prototype, "query", {
    ...
    get: function() {
      ...
      return this._delegate.docs.map(function(e) {
        return new Pc2(t3._firestore, e);
      });
    },
    enumerable: false,
    configurable: true
    ...
    return this._delegate.docChanges(t3).map(function(t4) {
      return new Mc2(e._firestore, t4);
    });
  }, t2.prototype.forEach = function(t3, e) {
    var n = this;
    this._delegate.forEach(function(r) {
      t3.call(e, new Pc2(n._firestore, r));
    });
  }, t2.prototype.isEqual = function(t3) {
    return $a2(this._delegate, t3._delegate);
  }, t2;
...
var qc2 = function(e) {
  ...
  return __extends(n, e), Object.defineProperty(n.prototype, "id", {
    ...
    get: function() {
      ...
      return t2 ? new Cc2(this.firestore, t2) : null;
    },
    enumerable: false,
    configurable: true
  }), n.prototype.doc = function(t2) {
    try {
      return new Cc2(this.firestore, t2 === void 0 ? ta2(this._delegate) : ta2(this._delegate, t2));
    } catch (t3) {
      throw xc2(t3, "doc()", "CollectionReference.doc()");
    }
  }, n.prototype.add = function(t2) {
    var e2 = this;
    return function(t3, e3) {
      var n2 = zu(t3.firestore, ua2), r = ta2(t3), i = hc2(t3.converter, e3);
      return mc2(n2, [Ea(Ta(t3.firestore), "addDoc", r._key, i, t3.converter !== null, {}).toMutation(r._key, De.exists(false))]).then(function() {
        return r;
      });
    }(this._delegate, t2).then(function(t3) {
      return new Cc2(e2.firestore, t3);
    });
  }, n.prototype.isEqual = function(t2) {
    return ea2(this._delegate, t2._delegate);
  }, n.prototype.withConverter = function(t2) {
    return new n(this.firestore, t2 ? this._delegate.withConverter(kc2.nu(this.firestore, t2)) : this._delegate.withConverter(null));
  }, n;
}(Fc2);
function Uc2(t2) {
  return zu(t2, $u);
